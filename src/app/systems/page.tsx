      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
        <div className="grid lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-4 sm:space-y-6">
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-primary-600 via-purple-600 to-indigo-700 text-white py-12 sm:py-16 md:py-20 rounded-xl sm:rounded-2xl">
            ...
            {/* Como Funciona */}
            <div id="como-funciona" className="py-8 sm:py-12 md:py-16 bg-white rounded-xl sm:rounded-2xl">
            ...
            <div id="sistemas" className="py-8 sm:py-12 md:py-16 bg-gray-50 rounded-xl sm:rounded-2xl">
              <div className="px-4 sm:px-6 lg:px-8">
