...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      console.log('[Login] Configuração NextAuth:', { 
        hasClientId, 
        hasClientSecret,
        hasNextAuthSecret,
        hasNextAuthUrl,
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-2xl">
          ...
          <button
            ...
            className="w-full py-2 sm:py-2.5 bg-white hover:bg-gray-50 text-gray-900 font-semibold rounded-lg sm:rounded-xl transition border border-gray-300 flex items-center justify-center space-x-2 sm:space-x-2.5 mb-3 sm:mb-4 text-xs sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
