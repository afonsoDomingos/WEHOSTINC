...
export const translations = {
  pt: {
    ...
    paymentSuccess: 'O seu pedido foi registado com sucesso. Aceda ao painel para gerir os seus serviços.',
    ...
    // Página Inicial
    heroBadge: 'Infraestrutura Datacenter de Última Geração',
    heroBadgeMobile: 'Datacenter de Alta Performance',
    heroTitle: 'Domínio, Hospedagem, Email e Site',
    heroSubtitle: 'Tudo o que a sua empresa precisa para ter uma presença online de alta performance em Moçambique com servidores ultrarrápidos e seguros.',
    whyChooseUs: 'Por que escolher a WEHOSTHERE?',
    ultraFast: 'Ultra Rápido',
    ultraFastDesc: 'Servidores de máxima performance',
    secure: '100% Seguro',
    secureDesc: 'Backup diário & proteção total',
    support247: 'Suporte 24/7',
    support247Desc: 'Equipa técnica sempre disponível',
    hostingPlans: 'Planos de Hospedagem',
    hostingPlansDesc: 'Escolha o plano ideal para o seu projeto com pagamento mensal ou anual com desconto.',
    oneMonth: '1 Mês',
    threeMonths: '3 Meses',
    sixMonths: '6 Meses',
    oneYear: '1 Ano',
    off: 'OFF',
    basicPlan: 'Básico',
    basicPlanDesc: 'Ideal para iniciantes',
    proPlan: 'Profissional',
    proPlanDesc: 'Para negócios em crescimento',
    popular: 'Popular',
  ...
  en: {
    ...
    paymentSuccess: 'Your order was registered successfully. Access the panel to manage your services.',
    ...
    // Página Inicial
    heroBadge: 'Next-Generation Datacenter Infrastructure',
    heroBadgeMobile: 'High-Performance Datacenter',
    heroTitle: 'Domain, Hosting, Email and Website',
    heroSubtitle: 'Everything your business needs for a high-performance online presence in Mozambique with ultra-fast and secure servers.',
    whyChooseUs: 'Why choose WEHOSTHERE?',
    ultraFast: 'Ultra Fast',
    ultraFastDesc: 'Maximum performance servers',
    secure: '100% Secure',
    secureDesc: 'Daily backup & total protection',
    support247: '24/7 Support',
    support247Desc: 'Technical team always available',
    hostingPlans: 'Hosting Plans',
    hostingPlansDesc: 'Choose the ideal plan for your project with monthly or annual payment with discount.',
    oneMonth: '1 Month',
    ...
    off: 'OFF',
    basicPlan: 'Basic',
    basicPlanDesc: 'Ideal for beginners',
  ...
  es: {
    ...
    // Página Inicial
    heroBadge: 'Infraestructura Datacenter de Última Generación',
    heroBadgeMobile: 'Datacenter de Alto Rendimiento',
    heroTitle: 'Dominio, Hospedaje, Email y Sitio',
    heroSubtitle: 'Todo lo que su empresa necesita para tener una presencia online de alto rendimiento en Mozambique con servidores ultrarrápidos y seguros.',
    whyChooseUs: '¿Por qué elegir WEHOSTHERE?',
    ultraFast: 'Ultra Rápido',
    ultraFastDesc: 'Servidores de máximo rendimiento',
    secure: '100% Seguro',
    secureDesc: 'Respaldo diario y protección total',
    support247: 'Soporte 24/7',
    support247Desc: 'Equipo técnico siempre disponible',
    hostingPlans: 'Planes de Hospedaje',
    hostingPlansDesc: 'Elija el plan ideal para su proyecto con pago mensual o anual con descuento.',
    oneMonth: '1 Mes',
    threeMonths: '3 Meses',
    sixMonths: '6 Meses',
    oneYear: '1 Año',
    off: 'OFF',
    basicPlan: 'Básico',
    basicPlanDesc: 'Ideal para principiantes',
    proPlan: 'Profesional',
