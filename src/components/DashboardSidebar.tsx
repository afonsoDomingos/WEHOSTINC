...
import { 
  ...
  LifeBuoy, Sparkles, Link2, FileText, Star, ShoppingBag
} from 'lucide-react';
      ...
      <nav className="space-y-1.5 sm:space-y-2">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <Icon className={`h-4 w-4 sm:h-5 sm:w-5 ${isActive ? 'text-primary-600' : isSiteQuote ? 'text-amber-600' : 'text-gray-500'}`} />
